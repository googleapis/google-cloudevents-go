...
func file_firebase_auth_v1_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_firebase_auth_v1_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_firebase_auth_v1_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_firebase_auth_v1_data_proto_msgTypes[2].Exporter = func(v any, i int) any {
