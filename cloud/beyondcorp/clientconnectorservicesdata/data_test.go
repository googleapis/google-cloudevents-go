...
package clientconnectorservicesdata_test
...
import (
	...
	"github.com/googleapis/google-cloudevents-go/cloud/beyondcorp/clientconnectorservicesdata"
...
func TestParsingClientConnectorServiceEventData(t *testing.T) {
	cases := testhelper.FindTestData(t, "ClientConnectorServiceEventData", "google/events/cloud/beyondcorp/clientconnectorservices/v1")
	...
	for name, file := range cases {
		t.Run(name, func(t *testing.T) {
			...
			t.Run("loose", func(t *testing.T) {
				out := clientconnectorservicesdata.ClientConnectorServiceEventData{}
