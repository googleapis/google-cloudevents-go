...
func file_cloud_beyondcorp_appconnectors_v1_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cloud_beyondcorp_appconnectors_v1_data_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_cloud_beyondcorp_appconnectors_v1_data_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_cloud_beyondcorp_appconnectors_v1_data_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_cloud_beyondcorp_appconnectors_v1_data_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_cloud_beyondcorp_appconnectors_v1_data_proto_msgTypes[5].Exporter = func(v any, i int) any {
