...
type LogEntryData struct {
	...
	Resource         *ResourceClass    `json:"resource,omitempty"`         // The monitored resource that produced this log entry.; ; Example: a log entry that reports a database error would be associated with; the monitored resource designating the particular database that reported; the error.
...
type ServiceAccountDelegationInfo struct {
	...
	ThirdPartyPrincipal *ThirdPartyPrincipal `json:"thirdPartyPrincipal,omitempty"` // Third party identity as the real authority.
}
...
type ResourceAttributesClass struct {
...
type RequestMetadata struct {
	...
	RequestAttributes       *Request               `json:"requestAttributes,omitempty"`       // Request attributes used in IAM condition evaluation. This field contains; request attributes like request time and access levels associated with; the request.; ; ; To get the whole view of the attributes used in IAM; condition evaluation, the user must also look into; `AuditLog.authentication_info.resource_attributes`.
}
...
// Request: Request attributes used in IAM condition evaluation. This field contains
...
// ResourceClass: The monitored resource that produced this log entry.
//
