...
var file_cloud_scheduler_v1_data_proto_goTypes = []interface{}{
...
func file_cloud_scheduler_v1_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_cloud_scheduler_v1_data_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Job); i {
			case 0:
				return &v.state
			case 1:
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_cloud_scheduler_v1_data_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_cloud_scheduler_v1_data_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*HttpTarget_OauthToken)(nil),
		(*HttpTarget_OidcToken)(nil),
	}
	file_cloud_scheduler_v1_data_proto_msgTypes[7].OneofWrappers = []interface{}{
